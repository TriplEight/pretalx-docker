...
cp config/traefik-old.yml /etc/portainer/pretalx/traefik/traefik.yml || error "Failed to create traefik route config!"
cp config/dynamic/config.yml /etc/portainer/pretalx/traefik/dynamic/config.yml || error "Failed to create traefik config!"
